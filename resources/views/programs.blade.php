                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form>
                                        ...
                                        padding-bottom: 20px;
                                        ">
                                        <label for="message-text" class="input-group">Anchor:</label>
                                        <input type="text" class="form-control">
                                        <span class="input-group-btn">
                                            <button type="button" class="btn btn-outline-success"><i class="fa fa-plus"></i> Add</button>
                                        </span>
                                    </div>

                                        <!--
                                        <div class="form-group">
                                            <label for="message-text" class="control-label">Anchor:</label>
                                            <input type="text" class="form-control" id="recipient-name1">
                                    ...
                                    <div class="form-group bg-light">
                                        <label for="message-text" class="control-label">Program Schedule:</label>
